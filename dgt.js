...
async function submitTimesheet() {
    ...
    const selectorOficinaMenu = 'input[id="publicacionesForm:oficina"]';
    const selectorOficina = 'select[id="sede"]';
    const selectorTramiteMenu = 'select[id="tramiteGrupo[0]"]';
    const selectorTramite = 'input[id="btnEntrar"]';
    const selectorPais = 'input[value="PASAPORTE"]';
